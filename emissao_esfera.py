...
randomSeed = 42
space = 0.1*kpc
lmax=lmaxFromCohrenceLength(space*2,boxSize,int(sys.argv[2])*kpc)
...
'''
print("lmax={} e lmin={}".format(lmax/kpc,2*space/kpc))
print ("Lc = {}kpc".format(turbulentCorrelationLength( 2*space, lmax , -11./3.)/kpc))  # correlation length
...
sim.add(PropagationBP(bField0,1e-3,0.1*kpc,10*kpc))
